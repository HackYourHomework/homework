...
const partnerNames = ['mia', 'emma', 'sara', 'ana', 'fatima'];

const locations = ['Amsterdam', 'Rotterdam', 'arnhem', 'zwolle', 'groningen'];

const jobTitles = ['doctor', 'lawyer', 'teacher', 'tailor', 'plumber'];
